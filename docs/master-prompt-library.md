...
## 3. Behavioral Sales Nudge
> "Based on this inquiry: {content}, provide a 1-sentence psychological nudge for the sales rep to use during the first 30 seconds of the call. Focus on loss aversion, reciprocity, or commitment consistency to increase conversion velocity."

## 4. Clinical Protocol Architect (Medical/Dental)
> "Generate a specialized Clinical Treatment Protocol for {topic}. Include average duration, clinical complexity (Routine, Standard, Advanced, Elite), and predicted clinical outcomes. Maintain a tone of professional medical authority."

## 5. Luxury Portfolio Asset Listing (Real Estate)
> "Generate a high-end Portfolio Inventory listing for {topic}. Focus on strategic appreciation nodes, luxury lifestyle DNS mapping, and architectural dominance. Include price estimate and square footage."

## 6. High-Ticket Proposal Architect
...
## 7. Conversational Triage (Chat Assistant)
